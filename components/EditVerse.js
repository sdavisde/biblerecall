...
import { GetBooks, GetChapters, GetVerses, UpdateVerse } from '../middleware/verse';

export default function EditVerse({ formSubmitted, books, verses, id }) {
    ...
    return (
        <div className={styles.container}>
            ...
            <button onClick={updateVerse} className={styles.addBtn}>Update Verse</button>
        </div>
	);
}